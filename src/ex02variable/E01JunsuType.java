...
public class E01JunsuType {
	...
	/*
	 정수자료형
	 -바이트, short,int,long, 타입(형)이 있다
	 - 각 자료형의 표현범위는 교안을 참조한다.
	 - 일반적으로 cpu 는 정수형 연산을 할때 인ㅌ형을
	 - 가장 빠르게 처리한다.
	 - 즉 정수형 변수는 대부분 인ㅌ형을 사용한다.
	 */
	public static void main(String[] args) {
		...
		/*
		 - int 보다 작은 자료형을 연산하면 컴파일러는 int형으로 변환하여 연산하다.
		 - byte, short형은 게임캐릭터의 움직임의 표현이나 음원정보등을 저장할 때
		 사용한다.
		 */
		...
		int result3 = short1 + short2;//byte + byte = int형
		...
		long result5 = short1 + long1;
		
		System.out.println("int1 + long1 = "+ result4);
		System.out.println("short1 + long1 = "+ result5);
