	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException{
		...
		/*
		 ...
		 1] 오라클용 JDBC드라이버를 메모리에 로드함
		 	: new를 사용하지 않고 클래스명으로 직접 찾아서 객체 생성후
		...
		/*
		 ...
		 오라클에 연결을 시도한다. 연결에 성공한경우 연결된 주소를 반환한다.
		 */
		...
		if(con!=null) {
			...
			/*
			 3] 쿼리문 작성
			 	: 쿼리문을 작성할때 주의할 점은 줄바꿈을 할때 앞뒤로
			 	스페이스를 삽입하는 것이 좋다. 그렇지않으면 서로 문장이
