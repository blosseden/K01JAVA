...
public class E01If01 {
	...
	public static void main(String[] args)  throws IOException {
		...
		int num = 10;
		/*
		 아래 문장은 조건식이 아닌 산술식이므로 에러발생이 된다.
		if(num%2) {
		...
		*/
		...
		//if(조건식); => 조건식에 상관엇ㅂ이 다음 문장이 실행되는 형태로
		...
		/*
		 조건검사후 실행할 문장이 하나인 경우에는 {} 중괄호를 생략
		 할 수 있다.단, 실행문이 2개이상인 경우에는 한문장만 실행되므로
		 주의해야 한다.
		 */
			System.out.println("\n"+ num +"은 짝수이다");
			if(num%2 !=0) {
		...
		/*
		 System.in.read()
		 	: 사용자에게 하나의 문자를입력 받을 때 사용하는 메소드로
...
//		System.out.println("입력한문자:"+ (char)asciiCode);
		...
		/*
		 ...
		 '0' => 48
		 '9' => 57이므로 해당 구간안에 있다면 숫자로 판단 할 수 있다.
