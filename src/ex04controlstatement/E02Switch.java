...
/*
 switch문
 	...
 	값가 ㄱ동일한 부분을 찾아 실행하는 형태를 가지고 있다.
 	형식]
 		switch(산술식or정수식) {
 		case 값1:
 			실행문1; break;
...
//	}
		 ...
		 */
		 String title = "히히힣";
		 switch(title) {
		 case "히히힣": System.out.println("쪼아!!!");
		 	break;
		 case "짜바": System.out.println("쪼아아아앙");
		 	break;
			}
		 ...
		 case 6: case 7: case 8:
			 ...
			 break;
		 case 9: case 10:
			 System.out.println("히히 시원해");
			 break;
		 case 11: case 12: case 1: case 2:
			 System.out.println("개추엉");
		 }
	 }	 
}
