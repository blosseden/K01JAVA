...
class MyStatic {
	...
	/*
	 ...
	 사용 할 수 없다. 정적멤버만 사용이 가능하다
	 (※main메소드에서는 static으로 선언된 메소드만 호출 할 수
	 있었음을 기억하자) static은 static끼리만 ㅇㅇㅇㅇ
	 */
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		 방법2 : 인스턴스 변수처럼 참조ㅂ현수를 통해 접근 할 수 있다.
		...
		/*
		 인스턴스 멤버변수는 객체별로 각각존재하므로 아래 초기화된
