...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		//one.privateMethod(); 에러발생(private는 같은 클래스 내에서만 사용가능)
		one.defaultMethod();
		one.publicMethod();
		
		/*
		 동일한 패키지에 선언된 클래스이므로 import 없이 객체생성 및
		 접근이 가능하다.
		 */
		...
		/*
		 다른 패키지에 정의돈 디폴트 클래스이므로 객체생성이 불가능하다.
		 import도 불가능하므로 아예 사용 할 수 없는 클래스이다.
		 */
		System.out.println("DefaultClass 객체 생성 및 접근");
