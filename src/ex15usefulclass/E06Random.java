...
public class E06Random {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 이를가르켜 가짜난수(Pseudo-random number)라고 한다
		 */
		System.out.println("### 난수생성 1 : seed로 32를 사용");
		Random random1 = new Random(32);
		for (int i = 0; i < 10; i++) {
			/*
			 nextInt()의 인자값 100이 전달되면0~99사이의
			 난수가 생성된다.
			 */
			System.out.println(random1.nextInt(100));
		}
		
		System.out.println("### 난수생성 2 : seed없음");
		Random random2 = new Random();
		for (int i = 0; i < 10; i++) {
			System.out.println(random2.nextInt(100));
		}
		
		System.out.println("### 난수생성3 : seed 없음");
