...
/*
 함수형 인터페이스
 	...
 	람다식으로 구현을 추상메소드를 선언한다.
 	이를 람다식을 만들기위한 함수형 인터페이스라고 한다.
 	※ 함수형 인터페이스에는 오직 하나의 추상메소드만 선언 할 수 있다.
...
public class Ex04FunctionalInterface {
	...
	/*
	 ...
	 해당 함수에서 studyLambda()를 호출하여 실행하고 있다.
	 */
	...
	public static void main(String[] args) {
		IKosmo4 kosmo = (str) ->
		System.out.println("IKosmo4를 구현받아 정의한 람다임"+str);
		execute(kosmo, "\n람다를 매개변수로 전달합니다.");
	}
