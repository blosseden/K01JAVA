...
/*
 람다식(Lambda Expression)
 	...
 	불편함 때문에 최근 함수형 프로그래밍(Functional Programming)
 	의 장점이 대두되었고, 이런 단점을
...
public class Ex03Lambda {
	...
	public static void main(String[] args) {
		...
		IKosmo3 kosmo = (String str) -> {
			System.out.println(str + "을 드디어 써보네요 ㅎㅎ");
		};
		kosmo.studyLambda("람다식");
		
		/*
		 위의 람다식을 아래와 같이 한번 줄이는게 가능함
		 - 매개변수의 타입을 예상 할 수 있다면 생략가능
		 - 매개변수가 하나라면 소괄호 생략가능
		 - 실행 할 문장이 하나이고, 동시에 return문이
		  아니라면 중괄호 생략가능
		 */
		IKosmo3 kosmo2 = str -> System.out.println(str+" 완전 간.단.한.걸?");
