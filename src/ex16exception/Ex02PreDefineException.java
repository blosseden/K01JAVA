	...
	public static void main(String[] args) {
		...
		try {
			...
			intArr[2] = 300;/*
			 				...
			 				*/
			System.out.println("않이;;"+ intArr[2]);
		}
		catch(ArrayIndexOutOfBoundsException e) {
			System.out.println("예외가 발생했어여");
			/*
			 getMessage() : 예외에 대한 간략한 메세제만 표시함
			 printStackTrace() : 예외가 발생 할 때의 에러메세지를
		...
		try {
			...
			System.out.println("느 10년후 나이는 말이야:"+ ageAfter10);
		}
