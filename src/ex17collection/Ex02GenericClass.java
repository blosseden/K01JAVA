...
class Apple{
	...
	public void showInfo() {
		System.out.println("사과의 무게는 "+ weight + "임");
	}
}
...
class Banner{
	...
	public void showInfo() {
		System.out.println("바나나의 당도는 "+ sugar + "임");
	}
}
...
자료형에 해당하는 대분을 대표문자 T(Type) 으로 교체하고 객체생성
ㅣ자료형을 결정하기 위해 "클래스명<T>" 형태로 변경한다.
 */
...
public class Ex02GenericClass {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 각각 Apple, Banner 객체를 저장 할 수 있는 인스턴스가
		 생성되었다.
		 */
		...
		/*
		 ...
		 생성되었기 때문에 다른 객체는 저장 할 수 없다. 아래 코드에서
