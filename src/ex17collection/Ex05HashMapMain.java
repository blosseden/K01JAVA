...
public class Ex05HashMapMain {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("네임이라는 키값으로 저장된 이전의 값은 말이야 : " +
		map.put("name","흐헹헹"));
		
		int number = 20;
		//map.put("age", number); value타입이 맞지않음
		map.put("age", String.valueOf(number));
		map.put("gender", "남자");
		map.put("address", "너의마음속이랄까");
		...
		/*
		 4.중복저장
		 	...
		 	"흐헹헹"이 출력된다. 그리고 기존의 값이 "이흐히ㅎㅇ"
		 	으로 갱신된다.
		 */
		
		System.out.println("name이라는 키값으로 저장된 이전의 값 : "+
						map.put("name","이흐히ㅎㅇ"));//덮어쓰기 처리
		...
		/*
		 5-2] 키값을 모를 때 출력하기
		 	...
		 	것이 불가능하다
		 	3. 키값을 얻어온 후 확장for문을 통해 key값을 하나씩
		 	출력한다.
		 */
		...
		/*
		 5-4] Value값만 얻어 올 때 : values() 메소드 사용
		 */
		...
		System.out.println(map.containsKey("name")?
				"name키값 있어" : "name키값 없엉ㅠ");
		System.out.println(map.containsKey("account")?
				"account키값 있어" : "account키값 없엉ㅠ");
