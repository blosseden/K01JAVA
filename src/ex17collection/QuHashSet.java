...
equals(), hashCode() 메소드를 적절히 오버라이딩 처리해야중복을 제거할 수 있다.
...
public class QuHashSet {
	...
	public static void main(String[] args) {
		...
		Avengers hero3 = new Avengers("브루스배너", "헐크", "진심펀치");
		...
		if(searchFlag == true) {
			System.out.println("요청하신 정보를 찾았습니다 ^오^b");
		}
		else {
			System.out.println("★☆그 영웅은 없.어. ㅗ^오^ㅗ ☆★");
		}
	}
