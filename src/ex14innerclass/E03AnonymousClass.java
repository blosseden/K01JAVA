...
public class E03AnonymousClass {
	...
	public static void main(String[] args) {
		...
		Person person = new Student("히힛", "2016");
		person.printInfo();
		...
		/*
		 ...
		 생각하자.
		 */
		//Student 클래스를 상속받아 정의한 익명클래스(즉 , Student의 하위 익명객체)
		...
		/*
		 하위 익명클래스에서 확장한 변수이므로 익명객체를 통해스는
		 접근불가.
		 */
		...
		그러나 익명클래스는 클래스명이 없기 때문에 위와 같이 다운캐스팅이
		불가능하다.
		즉, 익명클래스에서는 새롭게 정의한 멤버변수를 접근 할 수 없다.
		따라서 익명클래스는 오버라이딩의 목적으로만 사용해야 한다. 
		 */
		
		/*
		Person anonyTest = new Student("다운 캐스팅", "안됌깔깔") {
			String jumin = "001204";
		};
		...
		*/
		...
		Person anonyPerson = new Person("빼애애액") {
