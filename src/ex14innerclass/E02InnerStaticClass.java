...
class OuterClass {
	...
	void outerMemberMethod() {
		/*
		 ...
		 접근할 수 있다. (Heap영역에서는 Method영역을 참조
		 할 수 있다.)
		 */
	...
	static void outerStaticMethod() {
		...
		/*
		 ...
		 접근 할 수 있다.(Method영역에서는 Heap영역을 참조 할 수 없다.)
		 */
...
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		 내부정적 클래스의 정적멤버에 접근 할 때는 외부클래스의 객체 생성없이
		 클래스명으로 바로 접근이 가능하다.
		 */
		...
		/*
		 내부정적 클래스의 인스턴스멤버에 접근 할 때는 객체를 생성한 후
		 참조변수를 통해서 접근해야 한다.
		 */
