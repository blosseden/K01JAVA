...
class Account{
	/*
	 ...
	 클래스 내부에서만 접근이 가능하다. 즉 상속 받은 하위클래스에서
	 직접 접근은 불가능하다
	 */
	private int money;
...
class SavingAccount extends Account{
	/*
	 ...
	 super를 사용하고있다 이때 인자가 하나인 생성자를 호출하게된다.
	 */
	public SavingAccount(int initVal) {
		super(initVal);
	}
	/*
	 부모 클래스에 protected로 선언된 멤버메소드를 각각 호출한다
	 private멤버변수인 money는 직접 접근할수없으므로 접근
